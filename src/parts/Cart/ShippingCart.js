      ...
      <div className="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
        <form onSubmit={fnSubmit}>
          ...
          <div className="flex flex-col mb-4">
            <label name="complateName" className="text-sm mb-2">
              Complete Name
            </label>
            <input
              onChange={fnUpdateState}
              value={payload.complateName}
              type="text"
              name="complateName"
          ...
          <div className="flex flex-col mb-4">
            <label name="emailAddress" className="text-sm mb-2">
              Email Address
            </label>
            <input
              onChange={fnUpdateState}
          ...
          <div className="flex flex-col mb-4">
            <label name="address" className="text-sm mb-2">
              Address
            </label>
            <input
              onChange={fnUpdateState}
          ...
          <div className="flex flex-col mb-4">
            <label name="phoneNumber" className="text-sm mb-2">
              Phone Number
            </label>
            <input
              onChange={fnUpdateState}
                ...
                ? Array(2)
                    ...
                    .map((_, index) => (
                      <div key={index} className="px-2 w-6/12 h-24 mb-4">
                        <div className="bg-gray-300 w-full h-full animate-plus rounded-lg mx-2"></div>
                      </div>
                    ))
